...
if __name__ == "__main__":    
    ...
    parser.add_argument('--conf_thres', required=False, default=0.25, type=float, help='confidence threshold')
    parser.add_argument('--iou_thres', required=False, default=0.60, type=float, help='iou threshold')
